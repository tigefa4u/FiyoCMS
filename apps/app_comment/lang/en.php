...
/************** English *************/
@define ('comment_Leave_Comment',"Leave a Comment");
@define ('comment_Send',"Send");
@define ('comment_Reply',"Replt");
...
@define ('comment_Security_Code',"Securit Code");
@define ('comment_Notice_Error',"Please fill the required fields (*) !");
@define ('comment_Notice_Error2',"Email is invalid !");
