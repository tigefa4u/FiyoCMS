...
<h1>User Login</h1>
	...
	<?php echo userNotice; ?>
		...
		<div class="user-link">
			<span>&nbsp;</span><input type="submit" name="login" value="Login" class="button login"/> <?php echo @$new; ?> <a href="<?php echo make_permalink('?app=user&view=lost_password') ?>"><?php echo Lost_Password; ?>?</a>
		</div>
	</form>
</div>