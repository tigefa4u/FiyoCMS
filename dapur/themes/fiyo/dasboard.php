		...
		<div class="cols">
			<div class="col first pan" style='border :0 '>
				<div class='isi' id='notif'>
					...
					<div class='notif-item version'><a href="#updater" class="popup tooltip" title='Check for Updates' >
					<div><span><?php echo $version; ?></span></div>
					Fiyo Version</a>
					</div>					
				</div>
...
<div class="popup_warp">
	<div id="updater" class="pop_up" style="padding:10px">
		<div id="updater_id">		
		<h3>Loading for Updates</h3><img src="<?php echo AdminPath ?>/images/update.gif">
		</div>
	</div>	
</div>