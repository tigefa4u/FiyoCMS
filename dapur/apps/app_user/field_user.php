		...
		<div class="isi">
			<table class="data2">
				<tr>
					...
					<input type="text" id="username"  name="user" size="20" <?php echo formRefill('user',"$qr[user]"); ?> />
				...
				<tr>
					...
					<td><input type="password" name="x" style="display:none"><input type="password" name="password" size="20" id="pass"></td>
				</tr>
				<tr>
					<td class="djudul tooltip" title="<?php echo RePassword_tip; ?>">Re-Passowrd *</td>
					<td><input type="password" name="kpassword" size="20" id="repassword"><span id="pesan_repassword"></span></td>
				</tr>
				<tr>
					<td class="djudul tooltip" title="<?php echo User_Email_tip; ?>">Email *</td>
					<td><input type="email" id="email" name="email" size="30"   <?php echo formRefill('email',"$qr[email]"); ?> /><span id="pesan_email"></span></td>
				</tr>
				<tr>
		...
		<div class="isi">
			<table class="data2">
				<tr>
					...
					<td><input type="text" name="name" size="30"  <?php echo formRefill('name',"$qr[name]"); ?> ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><textarea name="bio" rows="5" style="width:100%; padding: 5px"><?php echo formRefill('bio',"$qr[about]",'textarea'); ?></textarea></td>
				</tr>
			</table>	
		</div>  
	</div> 
