...
// file names
define("PSNG_FILE_TEMPLATE_SETUP_EXPERT", 'apps/app_sitemap/templates/setup_expert.php');
define("PSNG_FILE_TEMPLATE_SETUP_SIMPLE", 'apps/app_sitemap/templates/setup_simple.php');
define("PSNG_FILE_TEMPLATE_EDIT_FILES", 'apps/app_sitemap/templates/edit_files.php');
define("PSNG_FILE_INC_SHUTDOWN", 'apps/app_sitemap/inc/shutdown.php');
