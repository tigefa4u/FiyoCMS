...
include_once('apps/app_sitemap/inc/Ontology.php');
include_once('apps/app_sitemap/inc/functions/functions.inc.php');
include_once('apps/app_sitemap/inc/functions/parsing.inc.php');
include_once('apps/app_sitemap/inc/functions/settings.inc.php');
...
include_once($SETTINGS[PSNG_FILE_SETTINGS]);
