...
*/    	$this->content['content_header'] = "";
    ...
    function addError($msg, $title="") {
    	if ($title != "") {
    		$tmp = '<div class="error">Error: '.$title.'</div>'."\n".'<div class="error">'.$msg.'</div>'."\n";
    	} else {
    ...
    function addWarning($msg, $title = "") {
    	if ($title != "") {
    		$tmp = '<div class="warning">Warning: '.$title.'</div>'."\n".'<div class="warning">'.$msg.'</div>'."\n";
    	} else {
    ...
    function addInfo($msg, $title = "") {
    	if ($title != "") {
    		$tmp = '<div class="info">Info: '.$title.'</div>'."\n".'<div class="info">'.$msg.'</div>'."\n";
    	} else {
    ...
    function addText($msg, $title = "", $css_class="") {
    	...
    	if ($title != "") $title = '<div'.$css_class.'>'.$title.'</div>';
    ...
    function addDebug($msg, $title = '') {
    	if ($title != "") {
    		$tmp = '<div class="debug">Debug: '.$title.'</div>'."\n".'<div class="debug">'.$msg.'</div>'."\n";
    	} else {
    ...
    function addSuccess($msg, $title = '') {
    	if ($title != "") {
    		$tmp = '<div class="success">Successful: '.$title.'</div>'."\n".'<div class="success">'.$msg.'</div>'."\n";
    	} else {
