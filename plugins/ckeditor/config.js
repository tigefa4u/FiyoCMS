...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserBrowseUrl = '../plugins/kcfinder/browse.php?type=files&dir=files';
	config.filebrowserImageBrowseUrl = '../plugins/kcfinder/browse.php?type=images&dir=images';
	config.filebrowserFlashBrowseUrl = '../plugins/kcfinder/browse.php?type=flash&dir=flash';	
	config.toolbar = 'Full';
	config.toolbar_Full =
	[
		{ name: 'source', items : [ 'Source'] },
		{ name: 'document', items : [ 'NewPage','Templates','-','DocProps','Preview','Print' ] },
